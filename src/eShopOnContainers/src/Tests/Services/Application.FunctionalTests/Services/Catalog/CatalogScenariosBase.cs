...
{
    using Startup = Microsoft.eShopOnContainers.Services.Catalog.API.Startup;

    public class CatalogScenariosBase
    {
        public TestServer CreateServer()
        {
            string path = Assembly.GetAssembly(typeof(CatalogScenariosBase))
                .Location;
            ...
            var hostBuilder = new WebHostBuilder()
                ...
                {
                    cb.AddJsonFile("Services/Catalog/appsettings.json", false)

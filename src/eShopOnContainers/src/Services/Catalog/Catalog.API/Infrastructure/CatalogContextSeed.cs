namespace Microsoft.eShopOnContainers.Services.Catalog.API.Infrastructure
{
    public class CatalogContextSeed
    {
        ...
        private CatalogItem CreateCatalogItem(string[] column,
            string[] headers,
        ...
        private IEnumerable<CatalogItem> GetPreconfiguredItems()
        {
            return new List<CatalogItem>
            {
                ...
                new CatalogItem
                {
                    CatalogTypeId = 3, CatalogBrandId = 2, AvailableStock = 100, Description = "Cup<T> Sheet", Name = "Cup<T> Sheet",
                    Price = 8.5M, PictureFileName = "11.png",
                },
                new CatalogItem
                {

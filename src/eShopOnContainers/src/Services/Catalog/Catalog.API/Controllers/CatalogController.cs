    ...
    public class CatalogController : ControllerBase
    {
            ...
            ICatalogIntegrationEventService catalogIntegrationEventService)
        {
            ...
            _catalogIntegrationEventService =
                catalogIntegrationEventService ?? throw new ArgumentNullException(nameof(catalogIntegrationEventService));
        ...
        public async Task<ActionResult<CatalogItem>> ItemByIdAsync(int id)
        {
            ...
            bool azureStorageEnabled = _settings.AzureStorageEnabled;
        ...
        [ProducesResponseType(typeof(PaginatedItemsViewModel<CatalogItem>), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<PaginatedItemsViewModel<CatalogItem>>> ItemsByTypeIdAndBrandIdAsync(int catalogTypeId,
            int? catalogBrandId,
            [FromQuery] int pageSize = 10,
            [FromQuery] int pageIndex = 0)
        {
        ...
        public async Task<ActionResult> UpdateProductAsync([FromBody] CatalogItem productToUpdate)
        {
            ...
            bool raiseProductPriceChangedEvent = oldPrice != productToUpdate.Price;
            ...
            if (
                raiseProductPriceChangedEvent) // Save product's data and publish integration event through the Event Bus if price has changed
            {
